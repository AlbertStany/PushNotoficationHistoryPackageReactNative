...
require("jest");
const SqliteNotificationRepository_1 = require("../SqliteNotificationRepository");
// Extend the class to access protected methods for testing
class TestableSqliteNotificationRepository extends SqliteNotificationRepository_1.SqliteNotificationRepository {
